package com.mk.ots.pay.module.weixin.pay.protocol.pay_protocol;
...
public class ScanPayReqData {
     ...
     */
    public ScanPayReqData(String authCode,String body,String attach,String outTradeNo,int totalFee,String deviceInfo,String spBillCreateIP,String timeStart,String timeExpire,String goodsTag,WxType type){
