...
import com.mk.ots.pay.module.weixin.pay.protocol.downloadbill_protocol.DownloadBillResData;
import com.mk.ots.pay.module.weixin.pay.service.DownloadBillService;
...
public class DownloadBillBusiness {
    ...
    public DownloadBillBusiness(WxType type) throws IllegalAccessException, ClassNotFoundException, InstantiationException {
        downloadBillService = new DownloadBillService(type);
    }
    ...
    public void run(DownloadBillReqData downloadBillReqData,ResultListener resultListener,WxType type) throws Exception {
        ...
        log.i("对账单API返回的数据如下：");
        downloadBillServiceResponseString = downloadBillService.request(downloadBillReqData,type);
