...
public class DownloadBillService extends BaseService{
    ...
    public DownloadBillService(WxType type) throws IllegalAccessException, InstantiationException, ClassNotFoundException {
        super(Configure.DOWNLOAD_BILL_API,type);
    }
     ...
     * @throws Exception
     */
    public String request(DownloadBillReqData downloadBillReqData,WxType type) throws Exception {

        //--------------------------------------------------------------------
        //发送HTTPS的Post请求到API地址
        //--------------------------------------------------------------------
        String responseString = sendPost(downloadBillReqData,type);
