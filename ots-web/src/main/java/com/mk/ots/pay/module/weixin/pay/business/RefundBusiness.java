...
import com.mk.ots.pay.module.weixin.pay.service.RefundService;
...
public class RefundBusiness {
    ...
    public RefundBusiness(WxType type) throws IllegalAccessException, ClassNotFoundException, InstantiationException {
        refundService = new RefundService(type);
    }
     ...
     * @throws Exception
     */
    public void run(RefundReqData refundReqData,ResultListener resultListener,WxType type) throws Exception {
