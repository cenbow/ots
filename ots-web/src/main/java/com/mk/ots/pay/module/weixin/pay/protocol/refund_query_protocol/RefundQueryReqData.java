package com.mk.ots.pay.module.weixin.pay.protocol.refund_query_protocol;
...
public class RefundQueryReqData {
    ...
    public RefundQueryReqData(String transactionID,WxType type){
...
//        setRefund_id(refundID);
    ...
    public RefundQueryReqData(String transactionID,String outTradeNo,String deviceInfo,String outRefundNo,String refundID,WxType type){
