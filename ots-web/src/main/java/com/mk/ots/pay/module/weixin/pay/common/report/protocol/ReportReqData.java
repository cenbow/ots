package com.mk.ots.pay.module.weixin.pay.common.report.protocol;
...
public class ReportReqData {
     ...
     */
    public ReportReqData(String deviceInfo, String interfaceUrl,int executeTimeCost, String returnCode,String returnMsg,String resultCode,String errCode,String errCodeDes, String outTradeNo,String userIp,WxType type){
        ...
        setSub_mch_id(Configure.getSubMchid(type));
