...
import com.mk.ots.pay.module.weixin.pay.common.*;
...
import com.mk.ots.pay.module.weixin.pay.protocol.refund_query_protocol.RefundOrderData;
...
import com.mk.ots.pay.module.weixin.pay.service.RefundQueryService;
...
public class RefundQueryBusiness {
    ...
    public RefundQueryBusiness(WxType type) throws IllegalAccessException, ClassNotFoundException, InstantiationException {
        refundQueryService = new RefundQueryService(type);
    }
     ...
     * @throws Exception
     */
    public void run(RefundQueryReqData refundQueryReqData,RefundQueryBusiness.ResultListener resultListener,WxType type) throws Exception {
