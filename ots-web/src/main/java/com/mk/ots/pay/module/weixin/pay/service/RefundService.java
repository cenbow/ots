...
public class RefundService extends BaseService{
    ...
    public RefundService(WxType type) throws IllegalAccessException, InstantiationException, ClassNotFoundException {
        super(Configure.REFUND_API,type);
    }
     ...
     * @throws Exception
     */
    public String request(RefundReqData refundReqData,WxType type) throws Exception {

        //--------------------------------------------------------------------
        //发送HTTPS的Post请求到API地址
        //--------------------------------------------------------------------
        String responseString = sendPost(refundReqData,type);
