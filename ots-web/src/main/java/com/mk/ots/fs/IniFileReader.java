...
public class IniFileReader {
	 ...
	 */
	public IniFileReader(String conf_filename) throws FileNotFoundException, IOException, URISyntaxException {
	...
	private void loadFromFile(String conf_filename) throws FileNotFoundException, IOException, URISyntaxException {
		FileReader fReader;
		...
		File file = new File(this.getClass().getResource("/" + conf_filename).toURI());
