...
public class ClientGlobal {
	 ...
	 */
	public static void init(String conf_filename) throws FileNotFoundException, IOException, FSException, URISyntaxException {
		...
		if (szTrackerServers == null) {
			throw new FSException("item \"tracker_server\" in " + conf_filename + " not found");
		}
	...
	public static int getG_connect_timeout() {
		return ClientGlobal.g_connect_timeout;
	}
	...
	public static int getG_network_timeout() {
		return ClientGlobal.g_network_timeout;
	}
	...
	public static int getG_tracker_http_port() {
		return ClientGlobal.g_tracker_http_port;
	}
	...
	public static boolean getG_anti_steal_token() {
		return ClientGlobal.g_anti_steal_token;
	}
	...
	public static String getG_secret_key() {
		return ClientGlobal.g_secret_key;
	}
	...
	public static TrackerGroup getG_tracker_group() {
		return ClientGlobal.g_tracker_group;
	}
